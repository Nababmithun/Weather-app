 ...
 */
public abstract class Hilt_WeatherRecylerviewFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WeatherRecylerviewFragment() {
    super();
  }

  Hilt_WeatherRecylerviewFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WeatherRecylerviewFragment_GeneratedInjector) this.generatedComponent()).injectWeatherRecylerviewFragment(UnsafeCasts.<WeatherRecylerviewFragment>unsafeCast(this));
    }
  }
